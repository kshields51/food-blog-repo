...
def individual_post_page(request, post_id):
    ...
    # grab all images
    top_level_dir = "food_blog_app/static/food_blog_app/images"
    ...
    print(context)
    return render(request, 'food_blog_app/individual_post.html', context)
...
def display_all_posts(request):
    ...
    return render(request, 'food_blog_app/index.html', context)
